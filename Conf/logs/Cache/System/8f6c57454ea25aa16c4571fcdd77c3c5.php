			...
			<td>
				<div id="header">
					<div class="top">
    	                <a class="logo"></a>
						 <div class="login">
							<li>您好：<b><?php echo (session('username')); ?></b> ，欢迎使小猪微信专家！</li>	
			                ...
			                <li><a href="http://wpa.qq.com/msgrd?v=3&uin=846961669&site=qq&menu=yes" target="_blank"> 联系我们</a></li>
					...
					<div class="topnav"><p><a href="#" id="togglemenu">隐藏菜单</a> 升级中,更多更新联系QQ846961669。</div>
				</div>
				<i class="tico"></i>
			</td>
		</tr>
